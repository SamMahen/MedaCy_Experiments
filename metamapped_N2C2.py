...
model.predict(testing_dataset_END, prediction_directory='/home/mahendrand/VE/Predictions/cross_domain/N2C2_END')

#run on a separate testing dataset
testing_dataset_CADEC = Dataset('/home/mahendrand/VE/Data/CADEC/converted')

# location to store the predictions
model.predict(testing_dataset_CADEC, prediction_directory='/home/mahendrand/VE/Predictions/cross_domain/N2C2_CADEC')